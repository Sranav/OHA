...
const FAQComponentMobile: React.FC = () => {
  ...
  const faqData: FAQItem[] = [
    ...
    {
      question: "High Performance Training Program",
      links: [
                  ...
                  {faq.question === "Sample Schedule" ? (
                    <div>
                      ...
                      <div className="bg-[#545454] text-white py-4 text-center">
                        <h2 className="text-[16px] font-normal">SAMPLE SCHOOL SCHEDULE</h2>
                      </div>

                      {/* Background image and content */}
                      <div
                        className="bg-cover bg-center p-[20px]"
                        style={{
